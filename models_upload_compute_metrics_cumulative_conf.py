...
def main():
    ...
    experiment_name_daft = ["11may_4group_NOaugmentation_manualfile",
                            "10may_4group_augmentation_manualfile",
    ...
    for exp_name in experiment_name_daft_2g:
        ...
        for num, folder in enumerate(folders):
            ...
            metrics_dict["fold"+str(num+1)] = metrics
        ...
        fig_conf_matrix.savefig(os.path.join(experiments_dir,
                                             exp_name,
                                             "confmatrix_acum_" + exp_name + "_test_fold" + str(num + 1) + ".png"))
        #print("classes ", classes)
        print("metrics experiment: ", exp_name, " probs: ", str(new_probs), " metrics: ", metrics)
