    ...
    for exp_name in experiment_name_daft:
        ...
        for num, folder in enumerate(folders):
            ...
            for position, batch in enumerate(test_loader):
                ...
                print(" name : ", name, " label : ", label, ' pred : ', round(preds[position].item()))
                ...
                print(" name attributes ", "attribute_" + group + "_" + name + "_pred_" + str(round(preds[position].item())) + "_" + exp_name + "_fold" + str(num + 1) + ".nii.gz")
                ...
                nib.save(nibabel.Nifti1Image(resized_attributes.squeeze().detach().numpy(), original.affine),
                         os.path.join("/home",
                                      ...
                                      "DAFT",
                                      'gradcam',
                                      "attribute_" + group + "_" + name + "_pred_" + str(round(preds[position].item())) + "_" + exp_name + "_fold" + str(num + 1) + ".nii.gz"))
