...
def main():
    ...
    for exp_name in experiments_dropout:
        ...
        # for each prob at each fold
        # for the case of 3 or 4 classes each fold will have 3 or 4 probabilities
        # for each class take the avg and take the best

        # majority voting
        #print("all probs ", [probs_dict["fold1"], probs_dict["fold2"], probs_dict["fold3"]])
        ...
        # for each class i have to count corrects and total
        # total of class i will be sum of elements in the target match i
        # correct of class i will be sum of elements in the new_pred match i
        correct = np.zeros(num_classes)
        total = np.zeros(num_classes)
        #for num_class in range(num_classes):
        #    total.append(sum(1 for i in targets if i == num_class))
        #for i, (p, t) in enumerate(zip(new_pred, targets)):
            ######
        #    correct[i] += int(p == t)
